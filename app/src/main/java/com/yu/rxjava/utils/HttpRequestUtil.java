...
/**
 * Created by Riven_rabbit on 2018/11/13.
 * 网络工具类
 */
...
public class HttpRequestUtil {
     ...
     */
    public void inner_GetFormAsync(String url,String action,Map<String, String> params, final DataCallBack callBack) {
//        Request.Builder builder = new Request.Builder();
//        Token.getTokenHaveId(url,action,builder);
        // TODO: 2018/11/16 拼接 没有header头
        if (params == null) {
            params = new HashMap<>();
        }
    ...
    private void inner_PostFormAsync(String url,String action, Map<String, String> params, final DataCallBack callBack) {
    ...
    private void inner_PostFormAsync(String url,String aid ,String gid,String action, Map<String, String> params, final DataCallBack callBack) {
        RequestBody requestBody;
        if (params == null) {
            params = new HashMap<>();
        }
...
//                deliverDataFailure(HttpUrlConstants.SERVER_ERROR, e, callBack);
     ...
     * @param callBack data
     */
    public static void okGetFormRequest(String url,String action, Map<String, String> params, DataCallBack callBack) {
        getInstance().inner_GetFormAsync(url,action,params, callBack);
    }
     ...
     * @param callBack data
     */
    public static void okPostFormRequest(String url,String action, Map<String, String> params, DataCallBack callBack) {
        getInstance().inner_PostFormAsync(url,action, params, callBack);
    }
